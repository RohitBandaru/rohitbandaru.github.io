...
{% include figure.liquid loading="lazy" path="assets/img/blog/distillation_ssl/moco.png" description="MoCo training" alt="MoCo training" width=700 %}
...
{% include figure.liquid loading="lazy" path="assets/img/blog/distillation_ssl/soft_vs_hard.png" caption="Shiba Inu dogs are known to have cat-like characteristics, soft labels can encode this by assigning some probability to the cat class." alt="dark knowledge" width=600 %}
...
{% include figure.liquid loading="lazy" path="assets/img/blog/distillation_ssl/kd.png" caption="Knowledge Distillation" alt="Knowledge Distillation" width=700 %}
...
{% include figure.liquid loading="lazy" path="assets/img/blog/distillation_ssl/seed.png" caption="SEED" alt="SEED" source="https://arxiv.org/abs/2101.04731" %}
...
{% include figure.liquid loading="lazy" path="assets/img/blog/distillation_ssl/seed2.png" caption="SEED training" alt="SEED training" width=700%}
...
{% include figure.liquid loading="lazy" path="assets/img/blog/distillation_ssl/s_vs_sl_kd.png" caption="Self-supervised KD with Supervised KD" alt="Self-supervised KD with Supervised KD" width=900%}
