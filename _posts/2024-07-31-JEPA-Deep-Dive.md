...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-02-24_at_9.21.30_AM.png" description=""%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-02-04_at_11.12.37_PM.png" width=400 description="High Level View of LeCun's Architecture for Intelligence"%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-02-19_at_1.04.13_PM.png" width=300 description=""%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-02-19_at_5.06.57_PM.png" width=400 description=""%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-02-19_at_5.28.15_PM.png" width=400 description=""%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-02-19_at_10.30.36_PM.png" width=500 description=""%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-02-24_at_9.19.56_AM.png" description=""%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-02-24_at_9.20.22_AM.png" description=""%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-04-06_at_5.39.36_PM.png" description=""%}
...
3. A random mask is calculated for the context. This is a 2D that is similar to the mask in I-JEPA. This mask is then repeated across the time dimension. This repetition is necessary because the videos are short and there would be too much redundancy for the same patch at different time steps. This redundancy would make the learning task too easy. This masking creates a context image, while the target is the original image.
    1. 2 masks are sampled: one short range and one long range. The short range mask covers less area in the image and is more discontinuous. These masks are constructed by different configurations of overlapping blocks, as done in I-JEPA.
        ...
        ![Short-range (left), long-range (right)](../../../images/jepa/Screenshot_2024-07-21_at_12.43.47_PM.png" description=""%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-07-21_at_12.17.52_PM.png" description="Very similar to I-JEPA but with an added temporal dimension."%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-07-21_at_8.56.24_AM.png" description=""%}
...
{% include figure.liquid loading="eager" path="assets/img/blog/jepa/Screenshot_2024-07-21_at_9.20.54_AM.png" description=""%}
